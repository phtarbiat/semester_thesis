function [x_out,numIterations,errorFlag,normFun,numFunEva,numJacEva] = newtonHo3(fun,jac,x_0,errorMargin,maxIteration)
% Implementation of 3rd order Newton-like line-search
%
% The implementation is based on Algorithm 2.3 in [12] with the general 
