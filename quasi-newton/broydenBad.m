function [x_out,numIterations,errorFlag,normFun,numFunEva,numJacEva] = broydenBad(fun,jac,x_0,errorMargin,maxIteration)
% Implementation of Broyden's Bad Method
%
...
for nIterations = 1:maxIteration
    ...
    s_k = x_k - x_kk;
    y_k = fun_k - fun_kk;
    H_k = H_k + ((s_k - H_k*y_k) * y_k') / (y_k' * y_k);
...
% found give back the laststate x_k and set the error to true
x_out = x_k;
