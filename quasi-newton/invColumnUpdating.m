function [x_out,numIterations,errorFlag,normFun,numFunEva,numJacEva] = invColumnUpdating(fun,jac,x_0,errorMargin,maxIteration)
% Implementation of the Inverse-Column-Updating-Method
%
...
for nIterations = 1:maxIteration
    ...
    e_k = zeros(n,1);
    e_k(idx_k) = 1;
    H_k = H_k + ((s_k - H_k*y_k) * e_k') / (e_k' * y_k);
